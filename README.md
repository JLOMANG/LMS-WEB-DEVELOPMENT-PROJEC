...
header img:hover {
  transform: scale(2.1); /* Zoom in effect on hover */
}
...
<li>Radiology services ( Iopa x ray, BBW, OPG, lateral cephalo grams,skull view, others..)</li>
 </ul>
 </section>
<section>
...
<h2>Contact Us</h2>
 ...
 <center>
 <p style="color: blue;">&copy; 2024 Kapenguria Dental Centre. All rights reserved.</p>
